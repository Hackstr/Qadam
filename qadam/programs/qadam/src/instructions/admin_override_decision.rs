...
use crate::events::MilestoneRejected;
...
pub fn handler(
    ...
    if approved {
        ...
        milestone.status = MilestoneStatus::Rejected;
        milestone.ai_decision = AiDecision::Rejected;
        milestone.ai_decision_hash = decision_hash;
...
pub struct AdminOverrideDecision<'info> {
